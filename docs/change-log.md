...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - make ERRATA_SME_POWER_DOWN work with the recommended state ID
      ...
      **See:** make ERRATA_SME_POWER_DOWN work with the recommended state ID ([26857ce](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/26857ce73658f494697460a43275d0d1796fc990))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - clean up FEAT_CSV2 checkers ([a4bf27b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a4bf27b2be2aa2bfd24ac190196e3259abb05aaa))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - add spaces around the CVE-2022-23960 on Neoverse V2 ([f0d7757](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f0d775708e910b1b96def5cee9e624c23a9a877e))

  - **SMCCC**

    - group the ARCH_WORKAROUND_Xs together ([c98f532](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c98f5322a9b69389bc6c2a22d37f7f2137d65b60))
...
- **Architecture**
  ...
  - **CPU feature / ID register handling in general**
    ...
    - added few helper functions ([e8423df](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e8423df24f0679bc53bb96f4c3433899ba36f8ca))
...
- **Platforms**
  ...
  - **Arm**
    ...
    - **TC**
      ...
      - enable workaround for CVE-2026-0995 ([4df9e92](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4df9e92ff198b4d67ef4d96c7d0590b03739989d))

- **Libraries**

  - **PSCI**

    - add psci_cpu_off_start event ([e8ead3a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e8ead3ae39c9088d65ef506dd2088c2b610abbc8))

  - **SMCCC**

    - add support for CPU Service calls ([82c7f43](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/82c7f4371f47f22f97c1e664812769bf9881d116))

### Documentation

- add security advisory for CVE-2025-10263 ([9432719](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9432719999385c24d24a5373cf9bffdae4e0d365))
- document lts candidate trailer ([2baa35a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2baa35a6f1ea3ac369f1d816f63fe1f103a6a98f))
- fill TFV advisory titles ([374c2ef](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/374c2effd81dccca61b312a82af7d12637b6ff6e))

- **Libraries**

  - **CPU Support**

    - explain why the ARCH_WORKAROUND_3 pseudo-erratum is needed ([c4e1b6a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c4e1b6a1ed771425d800bd8d2d5302a9d77f0d95))

- **Miscellaneous**

  - **Security**

    - add BL1 FWU DoS advisory details ([e8e0600](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e8e060002dee73f60f60e9e2800c66bc4de60786))
    - add security advisory for FIP TOC ([14a74ba](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/14a74badbb41950ced1694d4c83ddedda83f6e9a))

### Resolved Issues

- apply workaround for CVE-2025-10263 to N1 ([40b95ff](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/40b95ff12d5f3c0630bcfc5dce57ec5a5739f428))
- enable WORKAROUND_CVE_2025_10263 for affected platforms ([cf89a71](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/cf89a7166c95ca45a5fec5f7f711ee61d8fb4396))
- workaround for CVE-2025-10263 ([c4e1c88](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c4e1c88f6828b10a55fe1c3c7b411e8206bbacc3))

- **Architecture**

  - **Statistical profiling Extension (FEAT_SPE)**

    - add a psb before updating context and remove context saving ([ce560c3](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ce560c3cd2aa4eeb8e3afc6b63b91cde8bae4c2a))

  - **Trace Buffer Extension (FEAT_TRBE)**

    - add a tsb before context switching ([af846a0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/af846a0b29be8fb259f619651a18663b3034b202))

- **Platforms**

  - **NXP**

    - imx_trdc.h header guard ([cf8cf6f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/cf8cf6f36ba92124d5100084b79e88784cc8b088))
    - move PLAT_FUSE_FIP_* to plat_default_def ([526feae](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/526feaee29a46f39e281eb412ff995089c4e9785))

  - **ST**

    - **STM32MP1**

      - force soft float ABI and disable NEON ([9693f27](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9693f27875baa2ac2b7785339378f46c6aa9909e))

- **Libraries**

  - **CPU Support**

    - fix A78 workaround version for WORKAROUND_CVE_2024_5660 ([7433f2e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7433f2eebcd2503df1fb3b8b4b442ca03b699bee))
    - fix version for Cortex-X1 CVE-2024-5660 ([be76271](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/be76271172a899e664305d1fb604b3f6e7b1de7e))
    - fix version for Cortex-X2 CVE-2024-5660 ([a335e48](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a335e48c90848289d637fe66c8c7e373cb2d858e))
    - fix version for Cortex-X3 CVE-2024-5660 ([86305f5](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/86305f586f199408dcf1f32a0b76d29ee45a7987))
    - make ERRATA_SME_POWER_DOWN work with the recommended state ID ([26857ce](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/26857ce73658f494697460a43275d0d1796fc990))
    - only turn off CME when it is present ([6e02623](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/6e02623a77945179b0c46b03e8a3a7a025bc46bb))
    - return ERRATA_MISSING when errata not found ([af6f916](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/af6f916b6426befd98908eaa7e96729bb6cf940f))
    - sort erratum entries in A520 and X1 files ([247b3b4](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/247b3b4fc89e2eea71f6809a0e739a21dc574815))
    - unconstrain WORKAROUND_CVE_2025_0647 ([87c7979](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/87c797954ca9bde413d93f8163bdbb89b09937e7))
    - update Cortex-A77 applied revision for CVE-2024-5660 ([8762894](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/87628945394b259972fb6d4a6dcf13f288ec1f77))
    - update Cortex-A78C WORKAROUND_CVE_2024_5660 ([b036d14](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b036d142c862c48f1161e34f8730576c77fcd682))
    - use correct workaround for erratum N1 3324349 ([1f15d5f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1f15d5ffb2f3e015200e04437b604c973e584fa0))
    - workaround for C1-Pro erratum 3684268 ([b5ee1c3](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b5ee1c372e67c1b121aeea12c43c6431f32294f6))
    - workaround for Cortex-A510 erratum 1910738 ([15eb1a6](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/15eb1a64c62075af5fee55e88d8c1c469b321a14))
    - workaround for Cortex-A510 erratum 1937669 ([260482b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/260482b95502858b41ba78f83989ee7f56e540ff))
    - workaround for Cortex-A510 erratum 1942494 ([08cf31f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/08cf31f54802ce7e353d4985efd4123b7c80444c))
    - workaround for Cortex-A510 erratum 1952872 ([eb9a8b0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/eb9a8b0995c77f9e58624b64ecadd93e16324e69))
    - workaround for Cortex-A510 erratum 1966377 ([58f85ff](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/58f85ffdc8bf7f09fb7348f0f80a0aaaae9c2f1b))
    - workaround for Cortex-A510 erratum 1975068 ([b31e692](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b31e692587f8a8a2fa12ba3285326098c812baf2))
    - workaround for Cortex-A510 erratum 1976290 ([d9f57ea](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d9f57eaa98d861772fbbdbd0e61dc99b28c6b0c7))
    - workaround for Cortex-A510 erratum 2002389 ([139f17d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/139f17dba0edca0ca613548896adee3c69a666a4))
    - workaround for Cortex-A510 erratum 2027318 ([b1219e6](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b1219e6dee27693e0e3da5f2a338679b0c92cc5a))
    - workaround for Cortex-A510 erratum 2028010 ([4576ec4](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4576ec4c4cd3c7503dca9a00147f149086716c10))
    - workaround for Cortex-A520 erratum 2677201 ([215ee62](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/215ee6222b2a8d620e8f89330488b944d722256d))
    - workaround for Cortex-A520 erratum 3631357 ([ddbd6eb](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ddbd6eba6246881fd2a9df1d3f1504be455382d9))
    - workaround for Cortex-A520 erratum 3685825 ([9d29b94](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9d29b94b02afe354f32bbdc51bd1fa6c35820d35))
    - workaround for Cortex-A57 erratum 817171 ([ffd6be0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ffd6be0458efa332789fb8e6e713170fc8a58897))
    - workaround for Cortex-A57 erratum 836019 ([806a740](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/806a740d8b900145f12d72b1a21a1191a2afb269))
    - workaround for Cortex-A710 erratum 1785648 ([ff2770e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ff2770ebb8f4a3496b042552cee08e6d0e197080))
    - workaround for Cortex-A710 erratum 1793423 ([044f173](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/044f173c55f6e053ab96910d1001c13ff5531bd0))
    - workaround for Cortex-A710 erratum 1847092 ([c1e1c22](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c1e1c221a1c1c573975a47a708b2df82ecd6b968))
    - workaround for Cortex-A710 erratum 1887102 ([3f82617](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3f82617b27e5ade2b399de86867e4655cd6ec18f))
    - workaround for Cortex-A710 erratum 3888122 ([f7ab752](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f7ab75200dd9035c4e1315031c33a90abb223d3e))
    - workaround for Cortex-A710 erratum 4302969 ([d6c4cfd](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d6c4cfd8454137c353cadfa776d6b49f6b4c3a5e))
    - workaround for Cortex-A715 erratum 2238661 ([e3fe0ad](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e3fe0ada325268eaba550cd2e2fc1fcb41e9d502))
    - workaround for Cortex-A715 erratum 2239006 ([5fe987e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5fe987e6d488eb201da1553ec5c728cf65b58958))
    - workaround for Cortex-A715 erratum 2275754 ([2f2daad](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2f2daad17626a2f9e0d9d8681ff3b19d95413ffe))
    - workaround for Cortex-A715 erratum 2284544 ([dddc55c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/dddc55ce93deadc5ddf2a48126b83d5a2eeaec74))
    - workaround for Cortex-A715 erratum 2285473 ([ea72650](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ea726504a4806759d0438f5eb1b443e4ec55c460))
    - workaround for Cortex-A715 erratum 2292761 ([05d3b49](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/05d3b497f505b53cfaebe4d88c4c36ec07c2e3db))
    - workaround for Cortex-A76 erratum 2356586 ([6d47698](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/6d476981a1911ad2e5a0f6a021277c953ae14fbb))
    - workaround for Cortex-A76 erratum 3888013 ([65923e2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/65923e24e0d81556a7ff7b6b20d843373a43b4e6))
    - workaround for Cortex-A76AE erratum 3888014 ([47068df](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/47068dffdd1347ce351e93192cf1b8afabbd5ea3))
    - workaround for Cortex-A77 erratum 1160841 ([a6e750e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a6e750eea81a7ff522f9d7cd7ceaf5b8e6e75594))
    - workaround for Cortex-A77 erratum 1204882 ([a5c3dd4](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a5c3dd4495c84df4bc5179273ad3f14574617c6f))
    - workaround for Cortex-A77 erratum 1220737 ([63f41f8](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/63f41f8d13f92ffd6193faf3b6e78c0597a7e23c))
    - workaround for Cortex-A77 erratum 1253791 ([0a0830a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0a0830accebab429907549fe8bcdd909d340ecbf))
    - workaround for Cortex-A77 erratum 1273521 ([eb0e329](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/eb0e32921ab97227b531eb9cd75f44775fb93713))
    - workaround for Cortex-A77 erratum 1515815 ([56914ca](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/56914ca706142eecf52527e4c8f87ebd22b7eb2d))
    - workaround for Cortex-A77 erratum 3888015 ([1fee5aa](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1fee5aa3a90e8db99297a55662fefaaf729878e5))
    - workaround for Cortex-A78 erratum 1467580 ([45b5f0c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/45b5f0cca4573d5257e0efcbf7c5453ff4e90232))
    - workaround for Cortex-A78 erratum 1479939 ([ad33952](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ad33952491e3ca15ee0b433a8b149c096efefe2c))
    - workaround for Cortex-A78 erratum 1492189 ([3e9d28d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3e9d28df8c8340bf5b3ba56865dc3fe99b33f7e4))
    - workaround for Cortex-A78 erratum 1503072 ([e289069](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e2890692dce9a882782c62b8ac7b9b3126b45dfd))
    - workaround for Cortex-A78 erratum 1515634 ([4612236](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/46122363e8e45bdb804c5abe5a22f4d6015a358e))
    - workaround for Cortex-A78 erratum 1827429 ([c764e0c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c764e0c6ac7cc83602ac691919749ca1c7fc4df9))
    - workaround for Cortex-A78 erratum 3888017 ([17a805d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/17a805d13bdc596b8c611e9adbfdb29492a3551b))
    - workaround for Cortex-A78 erratum 4302972 ([b263d08](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b263d08a276d4724a9fc4e6482b5d45217fbdb64))
    - workaround for Cortex-A78AE erratum 1827431 ([830922f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/830922f9acba55656d15744f33ca18e739683939))
    - workaround for Cortex-A78AE erratum 1827433 ([37a31b1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/37a31b11c9a71fb8903bdc431c0a45424ff8d3ca))
    - workaround for Cortex-A78AE erratum 2242639 ([4465199](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4465199525fd59f264e57623e68851efcdd7b982))
    - workaround for Cortex-A78AE erratum 2466780 ([c7ed18d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c7ed18d19a266dcfb093d52d3ee5670ddd45a10a))
    - workaround for Cortex-A78AE erratum 2743229 ([cd30709](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/cd307097c7b28af5144a063bd9568db86bb9edf4))
    - workaround for Cortex-A78AE erratum 2779481 ([68ed88f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/68ed88fa3f4b32211299c0ad363f271d0a1caf77))
    - workaround for Cortex-A78AE erratum 3888018 ([5230724](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/52307249da44f95878ed72b23097799c5f4e9296))
    - workaround for Cortex-A78AE erratum 4302973 ([bbeec37](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/bbeec373d0a43014f2e92e6573822485dc4ec289))
    - workaround for Cortex-A78C erratum 1941499 ([9b1b087](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9b1b087cc47ef7a0307faa6d39a67da32f5f9286))
    - workaround for Cortex-A78C erratum 1951501 ([150cbf1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/150cbf10c926185e5e41756f9243ea47767ff7d6))
    - workaround for Cortex-A78C erratum 2376746 ([f6fe517](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f6fe51736e696cf7029e2cfd61a838d7def249af))
    - workaround for Cortex-A78C erratum 2395407 ([47e299c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/47e299cd3ce56d98cb826c41a49c27c1b5ffcff2))
    - workaround for Cortex-A78C erratum 2478780 ([fca3069](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/fca30699ceee4e90568c81c6ee90f0fddb2e36cf))
    - workaround for Cortex-A78C erratum 2779483 ([b464e1d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b464e1d6517751494e5888c38144fff12e04ebc5))
    - workaround for Cortex-A78C erratum 3888019 ([bd38784](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/bd38784e6fcf90b77388a3a15268b048c7cfa0bd))
    - workaround for Cortex-A78C erratum 4302974 ([3b99b82](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3b99b82f598a8228643081e26bbc966f836b6372))
    - workaround for Cortex-X1 erratum 1467580 ([37baaa2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/37baaa262b711aa3fba0d3d2fa4d2d7ee83f513d))
    - workaround for Cortex-X1 erratum 1479939 ([0022289](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0022289e0b49a8f51194355b6a76adc1f737603c))
    - workaround for Cortex-X1 erratum 1492189 ([66da29c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/66da29ceb2c83259c438eb2c997f23eea9d5caa5))
    - workaround for Cortex-X1 erratum 1503072 ([5158f40](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5158f40803b2113389008bdd5d47e85fcb6aa332))
    - workaround for Cortex-X1 erratum 1515634 ([fa6107a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/fa6107ac4bcd1ab36ba2fcbbf52cb3e2bfa8579b))
    - workaround for Cortex-X1 erratum 1941498 ([e34336e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e34336eb8386f3510253419fe11d64d83ecb52d8))
    - workaround for Cortex-X1 erratum 1951500 ([24bcfad](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/24bcfad30aaf877ae3525c6d68bd98eadbe96766))
    - workaround for Cortex-X1 erratum 1952683 ([309b59a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/309b59a125b09eaa4f39ce3ee13eeabfe1ba9631))
    - workaround for Cortex-X1 erratum 2376745 ([f317f05](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f317f05234b145f35455b4bf1659108d178716e5))
    - workaround for Cortex-X1 erratum 2395406 ([510a7cb](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/510a7cbc41f05362d9e6376beca06fea475b9c2b))
    - workaround for Cortex-X1 erratum 2742426 ([bba65f2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/bba65f2a861fe4588dcedcdd11f2f34af10a8f0f))
    - workaround for Cortex-X1 erratum 2779479 ([0af5b9c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0af5b9c432c5b8216d83ea687f65b0af2a6fb06b))
    - workaround for Cortex-X1 erratum 3888017 ([8115243](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8115243dcd96c053e0574d0fe83d0e6097f0b56f))
    - workaround for Cortex-X1 erratum 4302972 ([53c017f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/53c017ffbbb501e036a8c54dea66bac0de9690a5))
    - workaround for Cortex-X2 erratum 1785648 ([80a87bf](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/80a87bf02931e47f2dc405b509d12b0c90ce61df))
    - workaround for Cortex-X2 erratum 1793423 ([64ec6de](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/64ec6ded021de82fbebc8b2faa0444c49a67a86c))
    - workaround for Cortex-X2 erratum 1863568 ([723f1a5](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/723f1a562fe579bd123b29302bcc7d7524696ffb))
    - workaround for Cortex-X2 erratum 1887102 ([fd026bc](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/fd026bc69ef6116f31595b4570351ef18badf1e7))
    - workaround for Cortex-X2 erratum 1887413 ([75f3e56](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/75f3e565aebaf35346b70d2bb7b77f451102e943))
    - workaround for Cortex-X3 erratum 2138930 ([6c33f06](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/6c33f06ae6fb8c1ba9fde9a258e943bcb067828f))
    - workaround for Cortex-X3 erratum 2147714 ([9f2f384](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9f2f38480e2866942d32f4d21c2debcdc4cab29a))
    - workaround for Cortex-X3 erratum 2184829 ([d819cd6](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d819cd63245851ffff2c4b9d94f55cbf348123d4))
    - workaround for Cortex-X3 erratum 2214778 ([c064f7c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c064f7c8289f02bf1ea214a42bb0d1ce13737033))
    - workaround for Cortex-X4 erratum 2302507 ([9deab7d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9deab7d07fc4268ce731e823409e3fc5031235c1))
    - workaround for Cortex-X4 erratum 2620954 ([575c665](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/575c665661c0564d0df178394643d853fd617960))
    - workaround for Cortex-X4 erratum 2631888 ([9ea4088](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9ea4088d56a93245b944e1554e3e00840f05472a))
    - workaround for Cortex-X4 erratum 2646977 ([590818a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/590818acdba91850d85dc39615c4d5b95daeec18))
    - workaround for Cortex-X4 erratum 3841338 ([5d98000](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5d98000ddad2c3e9c3b4190ca214882a9330af94))
    - workaround for Neoverse N1 erratum 1791580 ([77fb120](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/77fb120022a89fc202cec556c7b6bb4d0978b390))
    - workaround for Neoverse N1 erratum 3888013 ([93722fd](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/93722fd867e02f813dbc3a0639da013c1df4485d))
    - workaround for Neoverse N1 erratum 925373 ([257eba5](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/257eba5da6be1455beb9e8d3cc970e570acaf4ee))
    - workaround for Neoverse V1 erratum 1542436 ([a5d928e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a5d928e3a398520ee1c7e87652231bd128311957))
    - workaround for Neoverse V1 erratum 1618634 ([a99ec0c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a99ec0c448b5bcb8c544fa717342f24e89b94174))
    - workaround for Neoverse V1 erratum 1618636 ([2d68f4a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2d68f4a4573d6e9b13eca3583b6fe2904c60fec2))
    - workaround for Neoverse V1 erratum 1619807 ([b93599a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b93599ac3c98893847c26be2b20c9ad21ffec88f))
    - workaround for Neoverse V1 erratum 1654562 ([2f6c429](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2f6c429986d9012d629d4f1b3171eb4fdbc2e8c4))
    - workaround for Neoverse V1 erratum 1674403 ([f3c8a8c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f3c8a8c6005eadb84206edcb518f5c33a015beaf))
    - workaround for Neoverse V1 erratum 3888016 ([4e884ae](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4e884aeba0f94507934a21464d1efb5bac0829fe))
    - workaround for Neoverse V2 erratum 2394277 ([ad9cd6e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ad9cd6e9d1f71b9c3297a3dfab209c4939d199c2))
  ...
  - **Arm**
    ...
    - **GIC**
      ...
      - **GICv3**
        ...
        - use the correct IPRIORITYR accessor ([04e762b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/04e762b69be99935b6962f036576bf762dfb012a))

- **Miscellaneous**

  - **Security**

    - workaround for C1-Pro/CME CVE-2026-0995 ([b9297ab](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b9297abcead3db342dbf4243bb9d71b62e9b7617))

- **Documentation**

  - augment Advisory for CVE-2018-19440 with available info ([363db92](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/363db924b003f9570ae33e082e4ae68ed76a583f))
  - use publicly accessible links for CVE-2017-15031 Advisory ([fd6fa29](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/fd6fa29e20989f2926425cffa28cdda10b2981ad))
  - use publicly accessible links for CVE-2022-47630 Advisory ([5a56ee4](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5a56ee4bb12d2d4260c595a9238fc296d832a9b7))
  - use publicly accessible links for CVE-2023-49100 Advisory ([38cf4a7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/38cf4a757fb6107afe67579d7f78403bd73e65f0))

## [lts-2.10.31](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/refs/tags/lts-v2.10.30..refs/tags/lts-v2.10.31) (2026-07-10)
...
- **Build System**
  ...
  - Mbed TLS is now included in the TF-A repository, and it
    ...
    **See:** add Mbed TLS submodule ([646f9c0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/646f9c0e73d6bd33feeab8f1b07034cd3cbe1ddb))
...
- **Platforms**
  ...
  - **Arm**
    ...
    - increase reserved DRAM1 mem for NS images ([e047faa](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e047faaeac220253af2803137ad2d1d1ef127cb4))

    - **Juno**

      - remove incorrect assert in sp min boot ([4591746](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4591746478fca629d547858bcf8a626873375cda))

  - **Broadcom**

    - fix bad Mbed TLS check ([e6efb99](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e6efb99239f0cffdaa465259417a421de64a7ab2))

  - **Marvell**

    - properly echo the make DDR command ([096c41b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/096c41b2ff6140e1066602bb4dbf0addec51b20d))
    - provide a default compile target ([50aa07e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/50aa07e9f30ee078331d2ddb122d584c4c5d4b6b))

    - **Armada**

      - mv_ddr path may not be a git repo ([10c7ff8](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/10c7ff840b0ec39abbb73b57a759bc8950a9e9ea))

      - **A8K**

        - declare amb_memory_map as an array ([a841273](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a841273adbd766367032598eb8569cb7e7e766f0))
        - mv_ddr path may not be a git repo ([dfeedd1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/dfeedd1e717a1eed7297a0034d3fc3aeed9db4d0))

- **Services**

  - **FF-A**

    - add NS memory node to fvp_spmc_optee_sp manifest ([5b3f7e0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5b3f7e014b5d1a040af523b10dde1ac141ffd675))

  - **SPM**

    - add device-regions used in tf-a-tests ([4123e4b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4123e4b5ac69ebd21c4c040873a69da67844c40b))
    - change the SMMUv3TestEngine being used ([0bf01e2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0bf01e2dcbc448720a9f1f95927c80de2a527a53))

- **Miscellaneous**

  - **Security**

    - avoid CVE_2025_0647 for bl2 build ([7c8382d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7c8382d70faf89aff91aaf8d13ad866ce249e3f5))

### New Features

- **common:** add support for kernel DT handoff convention ([f30d5ca](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f30d5ca5e0a246436619d40d5c378b1e37cfd28a))

- **Platforms**

  - **Arm**

    - add initrd props to dtb at build time ([2136ed7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2136ed7cf8b6d09957fa61eed8622b72fad167af))
    - unify Linux kernel as BL33 handling ([0f3c265](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0f3c265e5156b7dad98bed3410a60976d60bf987))

    - **FVP**

      - enable kernel dt convention ([5e47ce2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5e47ce2aad15ae470f8a6284727a2ce957feaffa))
      - give bootargs on all configs ([8cd5262](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8cd5262ebb0ac7b069d46540bbcaebf3416573f0))
      - give bootargs on all configs ([8c16d20](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8c16d20d21ce341adbb1653e66905b45476c50ce))
      - set defaults for build commandline ([861b436](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/861b43694d35383d4e288a3f3b00e2c14490df2f))
...
- **Drivers**
  ...
  - **Authentication**
    ...
    - **mbedTLS**
      ...
      - update mbedtls to version 3.6.5 ([16b3c52](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/16b3c52e3762780094d0dfd3e1757cf1825679f1))
      - update mbedTLS to version 3.6.6 ([bd3acc7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/bd3acc7b7bf1bc272027b664ddc1ed7f5c6ad913))

- **Build System**

  - add Mbed TLS submodule ([646f9c0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/646f9c0e73d6bd33feeab8f1b07034cd3cbe1ddb))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - reduce the footprint of errata reporting ([d70578f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d70578f820c74e26dfd5a9c017d5a5c52cafe0aa))
...
- **Libraries**
  ...
  - **Locks**
    ...
    - add bitlock ([0876588](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0876588cd309eb6fb944ea4a21da29f5de0a345b))
    - add non-blocking spinlock_try() API ([ee14acb](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ee14acb1444bd4c791451f99d50ffb51d956ac09))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - make errata reporting more generic ([528516d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/528516d6e66ed57ab25539bd154d379532843d4b))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - enable Neoverse-V2 external LLC support ([3eb1d91](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3eb1d91fcfc2ef40b55e317af1feb304b2afc17d))

  - **Locks**

    - mark spin_trylock as a public function ([7f53a3b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7f53a3bcfafaeae465a1176b436d2fb4ccba0069))

- **Miscellaneous**

  - **Security**

    - add CVE-2025-0647 for C1-Ultra ([387e7e4](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/387e7e470d6b350ac9f540c94d0af381fcf07180))
    - add CVE-2025-0647 for Cortex-A710 ([cc3fb61](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/cc3fb61cf3ef1a9cd58253b92a0123677bd89419))
    - add CVE-2025-0647 for Cortex-X2 ([ca45737](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ca457379932b19bf08c953afd54ff1bb5de41340))
    - add CVE-2025-0647 for Cortex-X3 ([b5c1f67](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b5c1f67ad44c65dd9f9a7239f252c8eb05a066f6))
    - add CVE-2025-0647 for Cortex-X4 ([c29605d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c29605d74dec160994b3cddd717ed4a5f8b79475))
    - add CVE-2025-0647 for Cortex-X925 ([0231076](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/023107645e4cb119010aba602a489cc9bfb5fd0c))
    - add CVE-2025-0647 for Neoverse-N2 ([79cc92f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/79cc92f6fe31fce01a749bbfd7bc03d33dbc022a))
    - add CVE-2025-0647 for Neoverse-V2 ([5573859](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5573859bc6a7b908fb00ad65cac461bab23aabc2))
    - add CVE-2025-0647 for Neoverse-V3 ([722fa1e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/722fa1ee23321a971006224df580214bf4da6f7f))
    - add workaround for CVE-2025-0647 ([3759bec](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3759bec840316fbd951e9eb33d1800d9d033bd16))

## [lts-2.10.28](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/refs/tags/lts-v2.10.27..refs/tags/lts-v2.10.28) (2026-01-23)
...
- **Libraries**
  ...
  - **MPMM**
    ...
    - greatly simplify MPMM enablement ([40d4274](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/40d4274e61fd0e74067c17cb662ab2d6764d3fe7))

  - **PSCI**

    - pass my_core_pos around instead of calling it repeatedly ([3c709d4](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3c709d45c371c8ba3398738a65eb4d84c46ead15))
...
- **Platforms**
  ...
  - **Arm**
    ...
    - **TC**
      ...
      - align core names to Arm Lumex ([7668035](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/76680356eaa5d3e8bb23f709d0a03dfb2f26a947))
...
- **Miscellaneous**
  ...
  - **Security**
    ...
    - add CVE-2024-5660 and CVE-2024-7881 reference links ([8fac8d7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8fac8d7a4861441054252d251bd8e7ad392b9938))
    - update CVE-2024-7881 affected CPU revisions ([288ccf2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/288ccf2d4d1d2f4d016957106f38e44c288d2b08))
    - update CVE-2024-7881 affected CPUs list ([1d04018](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1d04018a6b9eb6bc27edbcfc843179865a6e6e48))

### Code Refactoring

- panic after calling psci_power_down_wfi() ([a2bcc97](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a2bcc9754865e881e1b5861b36056e5bf1f86c05))

- **Libraries**

  - **CPU Support**

    - move CVE to the end of errata workaround ([31d69c7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/31d69c7f4081df111c588af17d0d74af8f3d9fb3))
    - reorder the errratum build flag for Neoverse-N2 ([ccc8e89](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ccc8e89633e14d003af64a0c6cf77a502afeac42))

  - **PSCI**

    - don't use PSCI_INVALID_PWR_LVL to signal OFF state ([1cf2bf6](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1cf2bf6da71045abe25a7e14cda4ff74714c2f74))
    - factor common code out of the standby finisher ([43ed1c9](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/43ed1c94de4491fa78c4114cd4df3fb01823f5a6))
    - move timestamp collection to psci_pwrdown_cpu ([14b29a9](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/14b29a9ee8cc49223aa9c32def86db302b327f5d))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - add support for Neoverse-N2 prefetcher ([504ef25](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/504ef25e4e50b10bc1803e609bf2c08c6f84438e))
    - fix external LLC presence bit in Neoverse N3 ([f60487b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f60487b17599339dec87df5003792e892208a206))
    - support to update External LLC presence in Neoverse N3 ([6517bc1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/6517bc1b91f5b782fa82cbd653593e5e4f53cb4c))

  - **PSCI**

    - allow cores to wake up from powerdown ([c09f098](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c09f0986c8e17c14aabd2cef5e9830ab6b1c665f))
...
- **Platforms**
  ...
  - **Arm**
    ...
    - **TC**
      ...
      - fix c1_pro power down abandon ([77df5e2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/77df5e208d0d3bee2f56c6a45d109fcfed9979a2))

- **Libraries**

  - **CPU Support**

    - avoid SME related loss of context on powerdown ([8b666d1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8b666d1d3396493958c484e604c55b2b4e7fa4d0))
    - fix C1 Pro powerdown abandon behavior ([a82a7b6](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a82a7b69404105b1e96a5b1e137223aae4af0535))
    - fix feature detection for C1-Pro erratum 3686597 ([3662586](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3662586d9fb5bfbbd90c96d4e7013ad72ef88e37))
    - fix the ordering of errata for C1 Ultra ([83d503b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/83d503beabeb90e327afd832fe803c766996bcd6))
    - register ARCH_WORKAROUND_3 for Neoverse V2 ([0ffe36d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0ffe36d6e6827e9b86ffee6890050238bfe416eb))
    - workaround for C1-Nano erratum 3392149 ([b8bb4da](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b8bb4da069a5b3d8373a24ff92669174433ab6cc))
    - workaround for C1-Nano erratum 3419531 ([d6a9405](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d6a9405fa5a94451f4a50937ede15f2f7e13c927))
    - workaround for C1-Nano erratum 3437202 ([bc72d7f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/bc72d7ffc11a7348c4cc053209bdc66924c05ca9))
    - workaround for C1-Nano erratum 3516455 ([e05e2f3](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e05e2f3b8b706e5a6f986ada0e965c3c736cb8d0))
    - workaround for C1-Nano erratum 3616450 ([6971381](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/6971381ce40ea70db5ec0262d5e6b4af793a6836))
    - workaround for C1-Nano erratum 3630925 ([e861120](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e861120e67cf9084430456e9213436938fd13495))
    - workaround for C1-Nano erratum 3754876 ([b40e8ae](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b40e8ae18b50e7d6fd462c2e9bb990ea08b898d2))
    - workaround for C1-Pro erratum 3300099 ([54f4add](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/54f4addefa00347bff35e1d23137f2a744d1e5f1))
    - workaround for C1-Pro erratum 3338470 ([edaeccb](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/edaeccbdeb313c20deb0a31d9b3c005b778154c9))
    - workaround for C1-Pro erratum 3362007 ([66f9ea7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/66f9ea736cb27192c128f963259fbde607479ff4))
    - workaround for C1-Pro erratum 3619847 ([ed90664](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ed90664cbda9d3bb67d70c8a68d5ece017ff0124))
    - workaround for C1-Pro erratum 3684268 ([03858cd](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/03858cd787ebb4534769eb7b26af7a0c524a8861))
    - workaround for C1-Pro erratum 3686597 ([73eb6ad](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/73eb6ad45f0fb07d0a2d25cdbb019d8e85942734))
    - workaround for C1-Pro erratum 3694158 ([56b6be2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/56b6be2c57636d88d12ecec71ada77daf54fe681))
    - workaround for C1-Pro erratum 3706576 ([f253a96](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f253a96008f8442f85174046dbe9c3f72c1175d9))
    - workaround for C1-Ultra erratum 3324333 ([a5b318c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a5b318c87a4ca193f4fac480176aec8970f6d5b5))
    - workaround for C1-Ultra erratum 3502731 ([118060e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/118060eda1500ce164f93e503e7d2e2ba0a8aa13))
    - workaround for C1-Ultra erratum 3651221 ([e89c1ca](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e89c1ca569f3ac54f5f9ceebcca27f9fc326fc27))
    - workaround for C1-Ultra erratum 3658374 ([9ef4c05](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9ef4c057490d02de3dfaa66c6081f2bb04f01899))
    - workaround for C1-Ultra erratum 3684152 ([0fa9f24](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0fa9f24fe529295f41d99a7727805f83a5d7531f))
    - workaround for C1-Ultra erratum 3705939 ([55fc5d1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/55fc5d11ed5543b8e459e6c00b3cf83db4ce910e))
    - workaround for C1-Ultra erratum 3815514 ([09740e1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/09740e1108894a54c06934416d222ad57ccd6eff))
    - workaround for C1-Ultra erratum 3865171 ([80f1d12](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/80f1d1219561013e50b59428fca8ba80c08082f5))
    - workaround for C1-Ultra erratum 3926381 ([6c16aac](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/6c16aac25706fd33178d3c9fb0ee509f3ea35699))
    - workaround for C1-Ultra erratum 4102704 ([aa2f25e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/aa2f25ec141abcc6aa4751f607d41a39d71e4b72))
    - workaround for Cortex-A710 erratum 3324338 ([b91eefa](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b91eefacb40643dea2a006bdb8d51dd133c3efc9))
    - workaround for Cortex-A715 erratum 3456084 ([e915c1e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e915c1e6c62fb1ec43c817c3d53797bbda29657c))
    - workaround for Cortex-A720 erratum 3456091 ([24b0ab9](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/24b0ab9417eb4e6542282cc0eb80f21eb31fdcf8))
    - workaround for Cortex-A76AE erratum 2753838 ([1f6f446](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1f6f446845115a820faa2059c0ea2444aed4b17e))
    - workaround for Cortex-X2 erratum 3324338 ([d9fbf86](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d9fbf86eccdcfc71f46844ebbf9c0228fdaac06f))
    - workaround for Cortex-X2 erratum 3888122 ([b61482b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b61482bf06b018977050c72ce5fbec3f843e60cc))
    - workaround for Cortex-X2 erratum 4302969 ([5ebfd47](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5ebfd47f41870914eab1e520d68ce84d0b5a7072))
    - workaround for Cortex-X3 erratum 3888125 ([9ef36d0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9ef36d072cb505f620ccb0a9a8fb7c0dacfb4006))
    - workaround for Cortex-X3 erratum 4302966 ([7dc2927](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7dc2927fe1002d05bcef0bb6ed3d90e364ca0cfd))
    - workaround for Cortex-X925 erratum 2921199 ([0d4a987](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0d4a987767e783049e7b9b0688556e1774b75bff))
    - workaround for Cortex-X925 erratum 2922378 ([077e213](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/077e213932d9125725edd6b324c3f5c778804851))
    - workaround for Cortex-X925 erratum 2933290 ([19394a0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/19394a0b54617c71a8d07fec1a4e955f150c1346))
    - workaround for Cortex-X925 erratum 3324334 ([e86fa43](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e86fa4366cd8b0fd8ea639e1e17d3f5d34c83c9d))
    - workaround for Cortex-X925 erratum 3692980 ([5a9da6e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5a9da6e3b76857cb5f49a6faf8d358b86562c4ec))
    - workaround for Cortex-X925 erratum 3730893 ([b6f44de](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b6f44deff6bfa573e99dc35573aa92dd0baafb7d))
    - workaround for Cortex-X925 erratum 3865185 ([7f953df](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7f953df9c2e0261b5247d789ad3b5c2883042d11))
    - workaround for Neoverse V3 erratum 3696307 ([ee26c2f](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ee26c2ff7241081a7bc1b266099789fe0e8c232b))
    - workaround for Neoverse V3 erratum 3734562 ([456ffac](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/456ffac0a9efada140a8ec8849e14361582ecb4b))
    - workaround for Neoverse V3 erratum 3782181 ([1aaea2d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1aaea2dd32580ded9568c927108a0573964cf61c))
    - workaround for Neoverse V3 erratum 3864536 ([3781d79](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3781d797e6547f8a2be3348b1f85e3bb2ae7a7a8))
    - workaround for Neoverse V3 erratum 3878291 ([f991550](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f9915508ac850eec970f8ab8a1b8f6620cae85cf))
    - workaround for Neoverse-N1 erratum 3324349 ([9e3f034](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9e3f0349ce826f780d69a2eebc412fd71b37547d))
    - workaround for Neoverse-N2 erratum 2138953 ([affc47b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/affc47b2731255566e634c7411ef02d2469adbf7))
    - workaround for Neoverse-N2 erratum 3324339 ([4dbea4a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4dbea4a63b87537574812c7b771a166ec889c156))
    - workaround for Neoverse-N2 erratum 3888123 ([2cd1dbc](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2cd1dbc87ef662fe26479561e1cf8380ffd1a219))
    - workaround for Neoverse-N2 erratum 4302970 ([9e8afb0](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9e8afb0a0c01eadc7ee8d6f50e79c36636a08f13))
    - workaround for Neoverse-N3 erratum 3456111 ([635f35c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/635f35ce618920377be63cb159c0cb18c233f364))
    - workaround for Neoverse-V2 erratum 3442699 ([1172841](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/11728415bac8ba957c5cf9cab6114439ad17d9f2))
    - workaround for Neoverse-V2 erratum 3888126 ([bdfe1d2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/bdfe1d245074abdb0fa2519dd251d83b89c7c78e))
    - workaround for Neoverse-V2 erratum 4302968 ([8d22042](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8d22042148f841cd38d3babb5dbaf5bc753fec8c))
    - workaround for Neoverse-V3 erratum 3312417 ([38aff6e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/38aff6e97643249d5fdb0adb29c45843dab8aca4))

- **Miscellaneous**

  - **Security**

    - add CVE-2024-7881 mitigation to C1-Pro CPU ([3266eee](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3266eeeeb602dae1b6c6c76a29934b6d67b6283d))
    - add CVE-2024-7881 mitigation to C1-Ultra CPU ([d355587](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d35558756972a9961d23ab17a299e57c35012c07))
    - update Cortex-X3 fix version for CVE-2024-7881 ([4545f66](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4545f66a451c67068b96c52b2bddfe2d22350ea2))
    - update Cortex-X4 fix version for CVE-2024-7881 ([0b87b4c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0b87b4c61a9c3df1d4480408c98dba4ce58b0dff))
    - update Cortex-X925 fix version for CVE-2024-7881 ([0eb47ec](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0eb47ecdda8c1e610e67cd8a782db634588b9f52))
    - update Neoverse-V2 fix version for CVE-2024-7881 ([1cf0b2d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1cf0b2d0cff7359ac072fa62aea01d616646d235))
    - update Neoverse-V3/V3AE fix version for CVE-2024-7881 ([76e5c0d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/76e5c0d9d093ede5066d1818785ef32863903da3))
...
- **deps-dev:** Bump @commitlint/cli from 19.0.0 to 19.8.1 ([c4e1d4a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c4e1d4aa4a74909fbdfccc62a43d899180d709e8))
- **deps-dev:** Bump @commitlint/config-conventional ([11ac166](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/11ac166ca2d433e3de7af1adcff5ae6bc03b6d53))
- **deps-dev:** Bump @commitlint/cz-commitlint from 19.0.0 to 19.8.1 ([8fd01f6](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8fd01f672096f276721252ebe8d5c7f1b0173011))
- **deps-dev:** Bump pip-tools from 6.13.0 to 6.14.0 ([a8a9443](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a8a94431895db299d1a7a155634cca21d06b8673))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - add sysreg_bit_toggle ([f13bcf9](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f13bcf9b122c247a73560da6913abc099bf16a8b))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - organize Cortex-X2 errata entries ([23da5c2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/23da5c284facb4eb7c3641b931f50887dc454fbc))
    - workaround for Cortex-X2 erratum 1901946 ([0c79e25](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0c79e2503d276fc351d493b001bf2807f60d049a))
    - workaround for Cortex-X2 erratum 1916945 ([8c1313b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8c1313b574e9faef347b3e80f4cf66b21586281e))
    - workaround for Cortex-X2 erratum 1917258 ([79048ea](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/79048ea189e6bf3e0497493e5c756e52a1e2e225))
    - workaround for Cortex-X2 erratum 1927200 ([7f23769](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7f237698e56cffb90be3b4d7419dfd1acd3f7d0a))
    - workaround for Cortex-X2 erratum 1934260 ([10388d9](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/10388d9410a3934ce711902874f4a022a34f1cc1))
    - workaround for Cortex-X2 erratum 2136059 ([d132002](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d1320024f853b57e9b5ae2b3819c59bbad5aa3c3))
    - workaround for Cortex-X2 erratum 2267065 ([158b267](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/158b267497f611151ad2073016c80426ee2ecc23))
    - workaround for Cortex-X2 erratum 2291219 ([211f268](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/211f2681b012a7e2aeb2690d90f7014f587c8da1))
    - workaround for Cortex-X4 erratum 3133195 ([45e66bf](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/45e66bf451d83ed0c2fae5d219f2201ac73d7322))
    - workaround for Cortex-X4 erratum 3887999 ([dbef7f7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/dbef7f7f408dab21bf528be07eedc458ed398ba8))
...
- **Miscellaneous**
  ...
  - **Security**
    ...
    - update Advisory TFV-6 ([d30f0ff](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d30f0ff2ca460fab1e15ef4ba6ce3933e29b119e))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - inline cpu_rev_var checks ([effb974](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/effb974f7500de06c31cf21f9f95d517982745a9))
    - inline the cpu_get_rev_var call ([adc2f6d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/adc2f6d30153dcf2c69d2663ddf8dc5c2741110d))
    - inline the init_cpu_data_ptr function ([9bd793d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9bd793ddae275fe6bef21dcd23c2a5deb7415ad1))
    - inline the reset function ([529f156](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/529f156df92b7f5fc3c68de959b33c6655b54c67))
    - make reset errata do fewer branches ([59beeab](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/59beeab016d08f68defcd5d12a82f81143022e33))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - convert checker functions to standard helpers ([9c7fbd7](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9c7fbd78d12ec95da1d0adefb52d6dd85629d9df))
    - convert the Cortex-A65 to use the errata framework ([e50d031](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e50d031484c65196bb1387fcceb14f8e2c4b7a0c))
    - declare runtime errata correctly ([9595d1c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/9595d1ca105842916c2f545936ef5dd8386fae2d))
    - directly invoke errata reporter ([0f9c514](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0f9c51473b01fa76e6aadda11cb3283c7f68cbdd))
    - don't panic if errata out of order ([acb9a81](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/acb9a81975319734921a536662110e1a04f7437c))
    - register DSU errata with the errata framework's wrappers ([0d708c3](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/0d708c335e6baa6f6f6316d305690cf42f1d6772))
    - remove cpu specific errata funcs ([13263fa](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/13263fa17a5ea8b0f8244cb4f306a24f8fef6ade))
    - undo errata mitigations ([c99a213](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/c99a213b19bbfd533f29351b1ad19f610feba1a5))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - fix cve order in Cortex-A77 ([3b8c35a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3b8c35a94722b8697b47e25faf0505307fd52130))
    - fix cve order in Cortex-A78 ([000077a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/000077a3e6ecfa189bda2496411d8feed93636df))
    - fix cve order in Cortex-A78_AE ([d83197e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d83197e39c8ba09de7c995f77e3e467e53f73b7e))
    - fix cve order in Cortex-A78C ([e77d574](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e77d574ac7aeb856af0b4f0681e19a97888117ff))
    - fix cve order in Cortex-X2 ([7ef97f2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7ef97f20e683a35880f95910baef28337191acd6))
    - fix cve order in Neoverse-V1 ([2384124](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2384124f94712fb12e7624446a641cb112cc82b3))
    - fix cve order in Neoverse-V2 ([3453be1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/3453be1e12ac6bc353227a18aff0f6690dedfc8a))
    - rearrange cve and errata order in Cortex-X3 ([8bf7772](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8bf777299fb5060e52b9fde85e3050a777b63816))
    - rearrange cve in order in Cortex-X1 ([65e79ac](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/65e79ac60a7d6e6db4f84b81511e47b0aa1e6394))
    - rearrange the errata and cve in order in Cortex-A710 ([b6d9fbb](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/b6d9fbb9788055ae7f9717aa84093aef5ce2d4fb))
    - rearrange the errata and cve in order in Cortex-X4 ([f1f9077](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f1f9077afb11299362ab4de6f19fbb6184a6479c))
    - rearrange the errata and cve in order in Neoverse-V3 ([acd429d](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/acd429d686dd820ebf77267a27a141ca13b4eaad))
    - rearrange the errata and cve order in Neoverse-N2 ([a43010c](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a43010cdc760689ed03986706254738a6554a972))
...
- **Services**
  ...
  - **ERRATA ABI**
    ...
    - add support for handling split workarounds ([d3d4154](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/d3d41542dd22d75293cb4da0b617e69d15dd356e))

- **Libraries**

  - **CPU Support**

    - declare reset errata correctly ([2f28a55](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2f28a55f4869c2034429b8bdf71791255e3a79c2))
    - fix clang compilation issue ([be6cb94](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/be6cb94960f7eb5a120334c7628ce7a82afde9ed))
    - remove errata setting PF_MODE to conservative ([8b413da](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8b413da85e5fbbe1288164c9d3958e0900b1cbd1))
    - workaround for Cortex-A715 erratum 2804830 ([e270eea](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/e270eea45dad1c6f24780cb39adbb289e2a7ab0c))
    - workaround for Cortex-X4 erratum 2957258 ([4c93936](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/4c939360b79ce4695dab45fcf687a768d41e0023))
    - workaround for Cortex-X925 erratum 2963999 ([1e0fca1](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/1e0fca13d9a4d2a0791a572c9e42207ae53bc0ad))
    - workaround for Neoverse-V3 erratum 2970647 ([f9429c2](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/f9429c20f223e73c71296c4ad90285fbb1cd639e))
    - workaround for Cortex-A510 erratum 2971420 ([7a3ec52](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/7a3ec52acbdcc15616e60fbd9ffbd365215363ed))

- **Dependencies**

  - remove deprecated husky commands ([8069c19](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/8069c192c4a9ea3f557985e2974164418dd0747a))

### Documentation

- add playbook for new releases ([5c9103e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/5c9103e53edf679608f33d1944bad34428f1aa1d))

- **Documentation**

  - **Prerequisites**

    - update mbedtls to v3.6.3 ([2f67407](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2f6740790b1caf319a1225b63f3b6a8e409e0dec))
...
- **Drivers**
  ...
  - **Authentication**
    ...
    - **mbedTLS**
      ...
      - update mbedtls to version 3.6.3 ([a8bec87](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/a8bec87aaa2e6b64a257667de3c2b723356862aa))
