...
static const struct ti_dev_clk_data MAIN_dev_clk_data[642] __section(".const.devgroup.MAIN") = {
...
static struct ti_dev_clk MAIN_dev_clk[642] __section(".bss.devgroup.MAIN");
