...
#define CRU_DMAC1_RST		BIT_WITH_WMSK(4)
 /* reset release*/
#define CRU_DMAC1_RST_RLS	WMSK_BIT(3)
...
/* reset hold*/
#define CRU_PMU_GPIO0_RST_HOLD		BIT_WITH_WMSK(7)
/* reset hold*/
#define CRU_PMU_GPIO1_RST_HOLD		BIT_WITH_WMSK(8)
#define WDT_GLB_RST_FIRST		BIT(1)
#define TSADC_GLB_RST_FIRST		BIT(0)
/**************************************************
  * sgrf reg, offset
  **************************************************/
...
#define SGRF_DDRRGN_CON20_34(n)		(((n) - 20) * 4)
