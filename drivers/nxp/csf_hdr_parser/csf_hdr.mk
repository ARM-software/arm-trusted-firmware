...
CSF_HDR_SOURCES	:=  drivers/nxp/csf_hdr_parser/csf_hdr_parser.c

ifdef BL2_SOURCES
CSF_HDR_SOURCES	+=  drivers/nxp/csf_hdr_parser/plat_img_parser.c
endif

PLAT_INCLUDES	+= -Idrivers/nxp/csf_hdr_parser/
