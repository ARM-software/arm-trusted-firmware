...
/**
 * @brief Convert integer value to hexadecimal string and store output from least
 *        significant nibble to most significant nibble
 *
...
/**
 * @brief Output trace debug string to UART
 *
 * @param str Pointer to hexadecimal string to output
