 ...
 * and cluster_affinity_val i.e. [15:8], the other bits will be ignored.
 */
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
/* UART GENI register spaces and offsets (base address is chipset specific).  */
/*----------------------------------------------------------------------------*/
...
/* NOC error interrupt IDs that vary per chipset live in the chipset header.   */
/*----------------------------------------------------------------------------*/
...
/* NOC error interrupts common to all chipsets */
