...
DEFINE_SYSREG_RW_FUNCS(pfar_el1)
DEFINE_SYSREG_RW_FUNCS(pfar_el2)
DEFINE_SYSREG_RW_FUNCS(mfar_el3)
...
/* Armv9.1 FEAT_BRBE instructions and registers */
static inline void brbiall(void)
{
	__asm__ volatile("sys #1, c7, c2, 4" : : : "memory");
}

static inline void brbinj(void)
{
	__asm__ volatile("sys #1, c7, c2, 5" : : : "memory");
}

DEFINE_RENAME_SYSREG_RW_FUNCS(brbcr_el2, BRBCR_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(brbidr0_el1, BRBIDR0_EL1)
...
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf0_el1, BRBINF0_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf1_el1, BRBINF1_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf2_el1, BRBINF2_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf3_el1, BRBINF3_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf4_el1, BRBINF4_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf5_el1, BRBINF5_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf6_el1, BRBINF6_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf7_el1, BRBINF7_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf8_el1, BRBINF8_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf9_el1, BRBINF9_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf10_el1, BRBINF10_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf11_el1, BRBINF11_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf12_el1, BRBINF12_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf13_el1, BRBINF13_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf14_el1, BRBINF14_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf15_el1, BRBINF15_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf16_el1, BRBINF16_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf17_el1, BRBINF17_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf18_el1, BRBINF18_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf19_el1, BRBINF19_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf20_el1, BRBINF20_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf21_el1, BRBINF21_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf22_el1, BRBINF22_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf23_el1, BRBINF23_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf24_el1, BRBINF24_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf25_el1, BRBINF25_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf26_el1, BRBINF26_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf27_el1, BRBINF27_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf28_el1, BRBINF28_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf29_el1, BRBINF29_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf30_el1, BRBINF30_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbinf31_el1, BRBINF31_EL1)

DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc0_el1, BRBSRC0_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc1_el1, BRBSRC1_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc2_el1, BRBSRC2_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc3_el1, BRBSRC3_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc4_el1, BRBSRC4_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc5_el1, BRBSRC5_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc6_el1, BRBSRC6_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc7_el1, BRBSRC7_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc8_el1, BRBSRC8_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc9_el1, BRBSRC9_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc10_el1, BRBSRC10_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc11_el1, BRBSRC11_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc12_el1, BRBSRC12_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc13_el1, BRBSRC13_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc14_el1, BRBSRC14_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc15_el1, BRBSRC15_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc16_el1, BRBSRC16_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc17_el1, BRBSRC17_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc18_el1, BRBSRC18_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc19_el1, BRBSRC19_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc20_el1, BRBSRC20_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc21_el1, BRBSRC21_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc22_el1, BRBSRC22_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc23_el1, BRBSRC23_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc24_el1, BRBSRC24_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc25_el1, BRBSRC25_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc26_el1, BRBSRC26_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc27_el1, BRBSRC27_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc28_el1, BRBSRC28_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc29_el1, BRBSRC29_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc30_el1, BRBSRC30_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbsrc31_el1, BRBSRC31_EL1)

DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt0_el1, BRBTGT0_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt1_el1, BRBTGT1_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt2_el1, BRBTGT2_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt3_el1, BRBTGT3_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt4_el1, BRBTGT4_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt5_el1, BRBTGT5_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt6_el1, BRBTGT6_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt7_el1, BRBTGT7_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt8_el1, BRBTGT8_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt9_el1, BRBTGT9_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt10_el1, BRBTGT10_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt11_el1, BRBTGT11_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt12_el1, BRBTGT12_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt13_el1, BRBTGT13_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt14_el1, BRBTGT14_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt15_el1, BRBTGT15_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt16_el1, BRBTGT16_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt17_el1, BRBTGT17_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt18_el1, BRBTGT18_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt19_el1, BRBTGT19_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt20_el1, BRBTGT20_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt21_el1, BRBTGT21_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt22_el1, BRBTGT22_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt23_el1, BRBTGT23_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt24_el1, BRBTGT24_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt25_el1, BRBTGT25_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt26_el1, BRBTGT26_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt27_el1, BRBTGT27_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt28_el1, BRBTGT28_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt29_el1, BRBTGT29_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt30_el1, BRBTGT30_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(brbtgt31_el1, BRBTGT31_EL1)
