...
static const struct ti_dev_clk_data MAIN_dev_clk_data[609] __section(".const.devgroup.MAIN") = {
...
static struct ti_dev_clk MAIN_dev_clk[609] __section(".bss.devgroup.MAIN");
...
const struct ti_dev_data * const soc_device_data_arr[AM62LX_DEV_CLK_32K_RC_SEL_DEV_VD + 1U] = {
...
struct ti_device soc_devices[AM62LX_DEV_CLK_32K_RC_SEL_DEV_VD + 1U];
