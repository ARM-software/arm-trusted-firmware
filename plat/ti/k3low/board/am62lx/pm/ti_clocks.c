...
static const struct ti_clk_data_from_dev clk_data_rtcss_wkup_0_osc_32k_clk = {
...
const struct ti_clk_data soc_clock_data[] = {
	[CLK_AM62LX_GLUELOGIC_HFOSC0_CLK] = {
	...
	[CLK_AM62LX_PLLFRACF2_SSMOD_16FFT_MAIN_0_FOUTVCOP_CLK] = {
		...
		.flags = TI_CLK_DATA_FLAG_NO_HW_REINIT,
	},
	...
	[CLK_AM62LX_HSDIV0_16FFT_MAIN_17_HSDIVOUT0_CLK] = {
		...
		.flags = TI_CLK_DATA_FLAG_MODIFY_PARENT_FREQ,
		.type = TI_CLK_TYPE_DIV,
	...
	[CLK_AM62LX_HSDIV0_16FFT_MAIN_8_HSDIVOUT0_CLK] = {
		...
		.drv = &ti_clk_drv_div_pll_16fft_hsdiv.drv,
		.flags = TI_CLK_DATA_FLAG_MODIFY_PARENT_FREQ | TI_CLK_DATA_FLAG_NO_HW_REINIT,
		.type = TI_CLK_TYPE_DIV,
