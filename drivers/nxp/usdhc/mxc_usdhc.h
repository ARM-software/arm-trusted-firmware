...
#ifndef __MXC_USDHC_H__
#define	__MXC_USDHC_H__

typedef struct mxc_usdhc_params {
	uintptr_t	reg_base;
	int		clk_rate;
	int		bus_width;
	unsigned int	flags;
...
#define XFERTYPE_RSPTYP_136	(1 << 16)
#define XFERTYPE_RSPTYP_48	(2 << 16)
#define XFERTYPE_RSPTYP_48_BUSY	(3 << 16)
