...
#if ARM_GPT_SUPPORT && defined(IMAGE_BL1)
/*
...
#if TRANSFER_LIST
#define PLAT_ARM_BL1_EXTRA_SIZE		PLAT_ARM_BL1_EVENT_LOG_MAX_SIZE
#else
#define PLAT_ARM_BL1_EXTRA_SIZE		PLAT_ARM_EVENT_LOG_MAX_SIZE
#endif
...
#define PLAT_ARM_BL1_EXTRA_SIZE		U(0)
#endif
