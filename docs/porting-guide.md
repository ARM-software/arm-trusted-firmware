...
### Function : platform_get_my_entrypoint() [mandatory when PROGRAMMABLE_RESET_ADDRESS == 0]
...
reset entrypoint point provided to `platform_setup_psci_ops()` during
...
### Function : platform_is_my_cpu_primary() [mandatory]
...
### Function : platform_core_pos_by_mpidr()
...
### Function : platform_set_my_stack()
...
### Function : platform_get_my_stack()
...
### Function : platform_get_power_domain_tree_desc() [mandatory]
...
is populated dynamically, then platform_core_pos_by_mpidr() and
platform_my_core_pos() should also be implemented suitably so that the topology
...
## Function : platform_setup_psci_ops() [mandatory]
