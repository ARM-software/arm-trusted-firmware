...
static struct power_domain scmi_power_domains[] = {
	...
	// AM62L_POWER_DOMAIN(AM62LX_DEV_TIMER1_CLKSEL_VD, str(TIMER1_CLKSEL_VD)),
	// AM62L_POWER_DOMAIN(AM62LX_DEV_TIMER3_CLKSEL_VD, str(TIMER3_CLKSEL_VD)),
	// AM62L_POWER_DOMAIN(AM62LX_DEV_WKUP_TIMER1_CLKSEL_VD, str(WKUP_TIMER1_CLKSEL_VD)),
};
